                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="attribute.html">Attribute</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="uservalues.html">UserValues</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="uservalueattribute.html">UserValue Attribute</a>
                                                    </li>
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="doctorform.html">Doctor Form</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="driverform.html">Driver Form</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="assistantform.html">Assistant Form</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="userType.html">Promote Users</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="daysOff.html">Attendance</a>
                                                </li>
                                                 <li class="nav-item">
                                                    <a class="nav-link" href="routePlan.html">Missions</a>
                                                </li>
                                                </ul>
                                </div>
                            </li>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                <td>'.$Row["type"].'</td>
												<td class="iconrow">
												  <a href="attributeEdit.php?ID='.$Row["ID"].'"><i class="fas fa-edit"  ></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
